...
pub fn render_dashboard_help(frame: &mut Frame, area: Rect) {
    ...
    let lines = vec![
        ...
        Line::from(Span::styled("  ────", sep_style)),
        binding_line("  :tnew", "new tab", key_style, desc_style),
        binding_line("  :tnext", "next tab", key_style, desc_style),
        binding_line("  :tprev", "previous tab", key_style, desc_style),
        binding_line("  :tdelete", "delete current tab", key_style, desc_style),
        Line::from(""),
